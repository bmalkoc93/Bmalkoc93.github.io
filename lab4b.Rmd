...
An important issue to note is that Twitter requires users to decide whether they want to opt into allowing the company to collect geotagged information on their tweets.   As a result of the change, it is estimated that  1-2\% of tweets have geographic coordinate information. 
